...
export const Request = {
  ...
  toJSON(message: Request): unknown {
    ...
    message.load_snapshot_chunk !== undefined &&
      (obj.load_snapshot_chunk = message.load_snapshot_chunk ? RequestLoadSnapshotChunk.toJSON(message.load_snapshot_chunk) : undefined)
    message.apply_snapshot_chunk !== undefined &&
      (obj.apply_snapshot_chunk = message.apply_snapshot_chunk ? RequestApplySnapshotChunk.toJSON(message.apply_snapshot_chunk) : undefined)
    return obj
  },
...
const baseRequestInfo: object = { version: '', block_version: 0, p2p_version: 0 }
...
export const RequestBeginBlock = {
  ...
  fromJSON(object: any): RequestBeginBlock {
    ...
    if (object.byzantine_validators !== undefined && object.byzantine_validators !== null) {
...
export const Response = {
  ...
  toJSON(message: Response): unknown {
    ...
    message.load_snapshot_chunk !== undefined &&
      (obj.load_snapshot_chunk = message.load_snapshot_chunk ? ResponseLoadSnapshotChunk.toJSON(message.load_snapshot_chunk) : undefined)
    message.apply_snapshot_chunk !== undefined &&
      (obj.apply_snapshot_chunk = message.apply_snapshot_chunk ? ResponseApplySnapshotChunk.toJSON(message.apply_snapshot_chunk) : undefined)
    return obj
  },
...
const baseResponseInfo: object = { data: '', version: '', app_version: 0, last_block_height: 0 }
...
const baseResponseCheckTx: object = { code: 0, log: '', info: '', gas_wanted: 0, gas_used: 0, codespace: '' }
...
const baseResponseDeliverTx: object = { code: 0, log: '', info: '', gas_wanted: 0, gas_used: 0, codespace: '' }
...
export const ResponseEndBlock = {
  ...
  fromJSON(object: any): ResponseEndBlock {
    ...
    message.validator_updates = []
    message.events = []
    if (object.validator_updates !== undefined && object.validator_updates !== null) {
  ...
  toJSON(message: ResponseEndBlock): unknown {
    ...
    message.consensus_param_updates !== undefined &&
      (obj.consensus_param_updates = message.consensus_param_updates ? ConsensusParams.toJSON(message.consensus_param_updates) : undefined)
    if (message.events) {
      obj.events = message.events.map((e) => (e ? Event.toJSON(e) : undefined))
    } else {
      obj.events = []
...
const baseResponseApplySnapshotChunk: object = { result: 0, refetch_chunks: 0, reject_senders: '' }

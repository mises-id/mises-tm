...
import MisesIdMisesTmMisesidMisestmV1Beta1 from './mises-id/mises-tm/misesid.misestm.v1beta1'
...
export default { 
  ...
  MisesIdMisesTmMisesidMisestmV1Beta1: load(MisesIdMisesTmMisesidMisestmV1Beta1, 'misesid.misestm.v1beta1'),

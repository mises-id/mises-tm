...
const baseGenesisState: object = { create_localhost: false, next_client_sequence: 0 }
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.clients_consensus !== undefined && object.clients_consensus !== null) {
      for (const e of object.clients_consensus) {
        message.clients_consensus.push(ClientConsensusStates.fromJSON(e))
      }
    }
    if (object.clients_metadata !== undefined && object.clients_metadata !== null) {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.next_client_sequence !== undefined && (obj.next_client_sequence = message.next_client_sequence)
    return obj
  },

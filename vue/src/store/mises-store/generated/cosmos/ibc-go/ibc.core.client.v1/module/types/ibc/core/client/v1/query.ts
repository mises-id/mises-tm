...
const baseQueryConsensusStateRequest: object = { client_id: '', revision_number: 0, revision_height: 0, latest_height: false }
...
export const QueryConsensusStatesResponse = {
  ...
  fromJSON(object: any): QueryConsensusStatesResponse {
    const message = { ...baseQueryConsensusStatesResponse } as QueryConsensusStatesResponse
    message.consensus_states = []
    if (object.consensus_states !== undefined && object.consensus_states !== null) {
...
export const QueryUpgradedConsensusStateResponse = {
  ...
  toJSON(message: QueryUpgradedConsensusStateResponse): unknown {
    const obj: any = {}
    message.upgraded_consensus_state !== undefined &&
      (obj.upgraded_consensus_state = message.upgraded_consensus_state ? Any.toJSON(message.upgraded_consensus_state) : undefined)
    return obj
  },

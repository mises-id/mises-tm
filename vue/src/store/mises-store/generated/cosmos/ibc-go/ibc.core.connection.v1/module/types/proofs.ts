...
const baseLeafOp: object = { hash: 0, prehash_key: 0, prehash_value: 0, length: 0 }
...
const baseInnerSpec: object = { child_order: 0, child_size: 0, min_prefix_length: 0, max_prefix_length: 0, hash: 0 }
...
export const InnerSpec = {
  ...
  toJSON(message: InnerSpec): unknown {
    ...
    message.min_prefix_length !== undefined && (obj.min_prefix_length = message.min_prefix_length)
    message.max_prefix_length !== undefined && (obj.max_prefix_length = message.max_prefix_length)

...
const baseMsgConnectionOpenInit: object = { client_id: '', delay_period: 0, signer: '' }
...
export const MsgConnectionOpenInit = {
  ...
  toJSON(message: MsgConnectionOpenInit): unknown {
    ...
    message.delay_period !== undefined && (obj.delay_period = message.delay_period)
...
const baseMsgConnectionOpenTry: object = { client_id: '', previous_connection_id: '', delay_period: 0, signer: '' }
...
export const MsgConnectionOpenTry = {
  ...
  fromJSON(object: any): MsgConnectionOpenTry {
    ...
    if (object.counterparty_versions !== undefined && object.counterparty_versions !== null) {
  ...
  toJSON(message: MsgConnectionOpenTry): unknown {
    ...
    message.proof_consensus !== undefined &&
      (obj.proof_consensus = base64FromBytes(message.proof_consensus !== undefined ? message.proof_consensus : new Uint8Array()))
...
const baseMsgConnectionOpenAck: object = { connection_id: '', counterparty_connection_id: '', signer: '' }

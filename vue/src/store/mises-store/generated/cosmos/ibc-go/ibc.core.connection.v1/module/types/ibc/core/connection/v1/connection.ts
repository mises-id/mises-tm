...
const baseIdentifiedConnection: object = { id: '', client_id: '', state: 0, delay_period: 0 }
...
export const Params = {
  ...
  decode(input: Reader | Uint8Array, length?: number): Params {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          message.max_expected_time_per_block = longToNumber(reader.uint64() as Long)
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  toJSON(message: Params): unknown {
    const obj: any = {}
    message.max_expected_time_per_block !== undefined && (obj.max_expected_time_per_block = message.max_expected_time_per_block)
    return obj
  },

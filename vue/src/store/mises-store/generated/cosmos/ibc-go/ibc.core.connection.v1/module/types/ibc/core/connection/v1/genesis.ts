...
export const GenesisState = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          message.next_connection_sequence = longToNumber(reader.uint64() as Long)
          break
        case 4:
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.client_connection_paths !== undefined && object.client_connection_paths !== null) {
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.next_connection_sequence !== undefined && (obj.next_connection_sequence = message.next_connection_sequence)

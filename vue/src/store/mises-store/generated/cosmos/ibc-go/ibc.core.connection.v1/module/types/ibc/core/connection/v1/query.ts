...
export const QueryClientConnectionsResponse = {
  ...
  fromJSON(object: any): QueryClientConnectionsResponse {
    const message = { ...baseQueryClientConnectionsResponse } as QueryClientConnectionsResponse
    message.connection_paths = []
    if (object.connection_paths !== undefined && object.connection_paths !== null) {
...
const baseQueryConnectionConsensusStateRequest: object = { connection_id: '', revision_number: 0, revision_height: 0 }

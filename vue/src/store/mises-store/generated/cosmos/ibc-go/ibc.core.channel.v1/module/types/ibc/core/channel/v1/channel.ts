...
const baseChannel: object = { state: 0, ordering: 0, connection_hops: '', version: '' }
...
export const Channel = {
  ...
  fromJSON(object: any): Channel {
    ...
    if (object.connection_hops !== undefined && object.connection_hops !== null) {
...
const baseIdentifiedChannel: object = { state: 0, ordering: 0, connection_hops: '', version: '', port_id: '', channel_id: '' }
...
const basePacket: object = { sequence: 0, source_port: '', source_channel: '', destination_port: '', destination_channel: '', timeout_timestamp: 0 }
...
export const Packet = {
  ...
  toJSON(message: Packet): unknown {
    ...
    message.timeout_timestamp !== undefined && (obj.timeout_timestamp = message.timeout_timestamp)
    return obj
  },

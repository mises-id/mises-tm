...
const baseClientUpdateProposal: object = { title: '', description: '', subject_client_id: '', substitute_client_id: '' }
...
export const Params = {
  ...
  fromJSON(object: any): Params {
    const message = { ...baseParams } as Params
    message.allowed_clients = []
    if (object.allowed_clients !== undefined && object.allowed_clients !== null) {

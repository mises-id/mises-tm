...
const baseQueryChannelClientStateRequest: object = { port_id: '', channel_id: '' }
...
export const QueryChannelClientStateResponse = {
  ...
  toJSON(message: QueryChannelClientStateResponse): unknown {
    const obj: any = {}
    message.identified_client_state !== undefined &&
      (obj.identified_client_state = message.identified_client_state ? IdentifiedClientState.toJSON(message.identified_client_state) : undefined)
    message.proof !== undefined && (obj.proof = base64FromBytes(message.proof !== undefined ? message.proof : new Uint8Array()))
    message.proof_height !== undefined && (obj.proof_height = message.proof_height ? Height.toJSON(message.proof_height) : undefined)
    return obj
  },
...
const baseQueryChannelConsensusStateRequest: object = { port_id: '', channel_id: '', revision_number: 0, revision_height: 0 }
...
export const QueryChannelConsensusStateRequest = {
  ...
  toJSON(message: QueryChannelConsensusStateRequest): unknown {
    ...
    message.port_id !== undefined && (obj.port_id = message.port_id)
    message.channel_id !== undefined && (obj.channel_id = message.channel_id)
    message.revision_number !== undefined && (obj.revision_number = message.revision_number)
    message.revision_height !== undefined && (obj.revision_height = message.revision_height)
    return obj
  },
...
const baseQueryPacketCommitmentRequest: object = { port_id: '', channel_id: '', sequence: 0 }
...
const baseQueryPacketCommitmentsRequest: object = { port_id: '', channel_id: '' }
...
const baseQueryPacketReceiptRequest: object = { port_id: '', channel_id: '', sequence: 0 }
...
const baseQueryPacketAcknowledgementRequest: object = { port_id: '', channel_id: '', sequence: 0 }
...
const baseQueryPacketAcknowledgementsRequest: object = { port_id: '', channel_id: '', packet_commitment_sequences: 0 }
...
export const QueryPacketAcknowledgementsRequest = {
        ...
        case 4:
          if ((tag & 7) === 2) {
            ...
            while (reader.pos < end2) {
              message.packet_commitment_sequences.push(longToNumber(reader.uint64() as Long))
            }
          } else {
            message.packet_commitment_sequences.push(longToNumber(reader.uint64() as Long))
          }
  ...
  fromJSON(object: any): QueryPacketAcknowledgementsRequest {
    ...
    if (object.packet_commitment_sequences !== undefined && object.packet_commitment_sequences !== null) {
...
const baseQueryUnreceivedPacketsRequest: object = { port_id: '', channel_id: '', packet_commitment_sequences: 0 }
...
const baseQueryUnreceivedAcksRequest: object = { port_id: '', channel_id: '', packet_ack_sequences: 0 }
...
export const QueryUnreceivedAcksRequest = {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          if ((tag & 7) === 2) {
            const end2 = reader.uint32() + reader.pos
            while (reader.pos < end2) {
              message.packet_ack_sequences.push(longToNumber(reader.uint64() as Long))
            }
          } else {
            message.packet_ack_sequences.push(longToNumber(reader.uint64() as Long))
          }
  ...
  fromJSON(object: any): QueryUnreceivedAcksRequest {
    ...
    if (object.packet_ack_sequences !== undefined && object.packet_ack_sequences !== null) {
...
const baseQueryNextSequenceReceiveRequest: object = { port_id: '', channel_id: '' }
...
const baseQueryNextSequenceReceiveResponse: object = { next_sequence_receive: 0 }
...
export const QueryNextSequenceReceiveResponse = {
  ...
  toJSON(message: QueryNextSequenceReceiveResponse): unknown {
    const obj: any = {}
    message.next_sequence_receive !== undefined && (obj.next_sequence_receive = message.next_sequence_receive)
    message.proof !== undefined && (obj.proof = base64FromBytes(message.proof !== undefined ? message.proof : new Uint8Array()))
    message.proof_height !== undefined && (obj.proof_height = message.proof_height ? Height.toJSON(message.proof_height) : undefined)
    return obj
  },

...
const baseParams: object = { community_tax: '', base_proposer_reward: '', bonus_proposer_reward: '', withdraw_addr_enabled: false }
...
export const ValidatorHistoricalRewards = {
  ...
  fromJSON(object: any): ValidatorHistoricalRewards {
    const message = { ...baseValidatorHistoricalRewards } as ValidatorHistoricalRewards
    message.cumulative_reward_ratio = []
    if (object.cumulative_reward_ratio !== undefined && object.cumulative_reward_ratio !== null) {
  ...
  toJSON(message: ValidatorHistoricalRewards): unknown {
    ...
    message.reference_count !== undefined && (obj.reference_count = message.reference_count)
    return obj
  },
...
const baseDelegatorStartingInfo: object = { previous_period: 0, stake: '', height: 0 }

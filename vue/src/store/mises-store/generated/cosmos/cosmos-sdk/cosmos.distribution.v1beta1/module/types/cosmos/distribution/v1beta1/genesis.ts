...
const baseDelegatorWithdrawInfo: object = { delegator_address: '', withdraw_address: '' }
...
export const ValidatorOutstandingRewardsRecord = {
  ...
  fromJSON(object: any): ValidatorOutstandingRewardsRecord {
    ...
    if (object.outstanding_rewards !== undefined && object.outstanding_rewards !== null) {
...
const baseValidatorAccumulatedCommissionRecord: object = { validator_address: '' }
...
const baseValidatorHistoricalRewardsRecord: object = { validator_address: '', period: 0 }
...
const baseDelegatorStartingInfoRecord: object = { delegator_address: '', validator_address: '' }
...
const baseValidatorSlashEventRecord: object = { validator_address: '', height: 0, period: 0 }
...
export const ValidatorSlashEventRecord = {
  ...
  toJSON(message: ValidatorSlashEventRecord): unknown {
    ...
    message.period !== undefined && (obj.period = message.period)
    message.validator_slash_event !== undefined &&
      (obj.validator_slash_event = message.validator_slash_event ? ValidatorSlashEvent.toJSON(message.validator_slash_event) : undefined)
    return obj
  },
...
export const GenesisState = {
  ...
  fromJSON(object: any): GenesisState {
    ...
    if (object.delegator_withdraw_infos !== undefined && object.delegator_withdraw_infos !== null) {
    ...
    if (object.validator_accumulated_commissions !== undefined && object.validator_accumulated_commissions !== null) {
    ...
    if (object.validator_historical_rewards !== undefined && object.validator_historical_rewards !== null) {
    ...
    if (object.validator_current_rewards !== undefined && object.validator_current_rewards !== null) {
    ...
    if (object.delegator_starting_infos !== undefined && object.delegator_starting_infos !== null) {
    ...
    if (object.validator_slash_events !== undefined && object.validator_slash_events !== null) {

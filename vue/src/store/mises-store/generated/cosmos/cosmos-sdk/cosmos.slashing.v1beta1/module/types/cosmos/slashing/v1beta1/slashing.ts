...
const baseValidatorSigningInfo: object = { address: '', start_height: 0, index_offset: 0, tombstoned: false, missed_blocks_counter: 0 }
...
export const ValidatorSigningInfo = {
  ...
  toJSON(message: ValidatorSigningInfo): unknown {
    ...
    message.jailed_until !== undefined && (obj.jailed_until = message.jailed_until !== undefined ? message.jailed_until.toISOString() : null)
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    message.downtime_jail_duration !== undefined &&
      (obj.downtime_jail_duration = message.downtime_jail_duration ? Duration.toJSON(message.downtime_jail_duration) : undefined)

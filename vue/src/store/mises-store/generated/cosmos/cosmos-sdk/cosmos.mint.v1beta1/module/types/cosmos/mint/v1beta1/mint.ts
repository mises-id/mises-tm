...
export interface Params {
  ...
  /** annual change in inflation limit */
  inflation_limit_change: string
}
...
export const Params = {
  encode(message: Params, writer: Writer = Writer.create()): Writer {
    ...
    if (message.inflation_limit_change !== '') {
      writer.uint32(58).string(message.inflation_limit_change)
    }
    return writer
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6:
          ...
          break
        case 7:
          message.inflation_limit_change = reader.string()
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  fromJSON(object: any): Params {
    ...
    if (object.inflation_limit_change !== undefined && object.inflation_limit_change !== null) {
      message.inflation_limit_change = String(object.inflation_limit_change)
    } else {
      message.inflation_limit_change = ''
    }
    return message
  },
  ...
  toJSON(message: Params): unknown {
    ...
    message.inflation_limit_change !== undefined && (obj.inflation_limit_change = message.inflation_limit_change)
    return obj
  },
  ...
  fromPartial(object: DeepPartial<Params>): Params {
    ...
    if (object.inflation_limit_change !== undefined && object.inflation_limit_change !== null) {
      message.inflation_limit_change = object.inflation_limit_change
    } else {
      message.inflation_limit_change = ''
    }
    return message

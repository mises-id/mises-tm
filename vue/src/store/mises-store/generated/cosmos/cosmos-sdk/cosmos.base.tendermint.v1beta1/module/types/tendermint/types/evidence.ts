...
export const Evidence = {
  ...
  toJSON(message: Evidence): unknown {
    const obj: any = {}
    message.duplicate_vote_evidence !== undefined &&
      (obj.duplicate_vote_evidence = message.duplicate_vote_evidence ? DuplicateVoteEvidence.toJSON(message.duplicate_vote_evidence) : undefined)
    message.light_client_attack_evidence !== undefined &&
...
const baseDuplicateVoteEvidence: object = { total_voting_power: 0, validator_power: 0 }
...
const baseLightClientAttackEvidence: object = { common_height: 0, total_voting_power: 0 }

...
const baseValidator: object = { address: '', voting_power: 0, proposer_priority: 0 }
...
export const GetNodeInfoResponse = {
  ...
  toJSON(message: GetNodeInfoResponse): unknown {
    ...
    message.application_version !== undefined &&
      (obj.application_version = message.application_version ? VersionInfo.toJSON(message.application_version) : undefined)
    return obj
  },
...
const baseVersionInfo: object = { name: '', app_name: '', version: '', git_commit: '', build_tags: '', go_version: '', cosmos_sdk_version: '' }

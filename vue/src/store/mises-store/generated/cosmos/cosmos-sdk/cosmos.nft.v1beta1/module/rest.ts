...
export interface V1Beta1QueryNFTsOfClassResponse {
  nfts?: V1Beta1NFT[];
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   *
   * @tags Query
   * @name QueryNfTsOfClass
   * @summary NFTsOfClass queries all NFTs of a given class or optional owner, similar to tokenByIndex in ERC721Enumerable
   * @request GET:/cosmos/nft/v1beta1/nfts/{class_id}
   */
  queryNfTsOfClass = (
    class_id: string,
    query?: {
    ...
    this.request<V1Beta1QueryNFTsOfClassResponse, RpcStatus>({
      path: `/cosmos/nft/v1beta1/nfts/${class_id}`,
      method: "GET",
      query: query,
      format: "json",
      ...params,

...
const baseQueryNFTsOfClassRequest: object = { class_id: '', owner: '' }

export const QueryNFTsOfClassRequest = {
  encode(message: QueryNFTsOfClassRequest, writer: Writer = Writer.create()): Writer {
    if (message.class_id !== '') {
      writer.uint32(10).string(message.class_id)
    }
    if (message.owner !== '') {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryNFTsOfClassRequest {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
...
export const QueryNFTsOfClassResponse = {
  encode(message: QueryNFTsOfClassResponse, writer: Writer = Writer.create()): Writer {
  ...
  decode(input: Reader | Uint8Array, length?: number): QueryNFTsOfClassResponse {
    const reader = input instanceof Uint8Array ? new Reader(input) : input
    let end = length === undefined ? reader.len : reader.pos + length
...
export const QueryClassResponse = {
  encode(message: QueryClassResponse, writer: Writer = Writer.create()): Writer {
...
export const QueryClassesRequest = {
  encode(message: QueryClassesRequest, writer: Writer = Writer.create()): Writer {
    if (message.pagination !== undefined) {
...
export const QueryClassesResponse = {
  encode(message: QueryClassesResponse, writer: Writer = Writer.create()): Writer {
...
export class QueryClientImpl implements Query {
  ...
  NFTsOfClass(request: QueryNFTsOfClassRequest): Promise<QueryNFTsOfClassResponse> {
    ...
    return promise.then((data) => QueryNFTsOfClassResponse.decode(new Reader(data)))
  }

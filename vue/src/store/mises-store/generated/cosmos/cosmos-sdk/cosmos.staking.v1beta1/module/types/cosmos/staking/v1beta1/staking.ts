...
const baseCommissionRates: object = { rate: '', max_rate: '', max_change_rate: '' }
...
const baseDescription: object = { moniker: '', identity: '', website: '', security_contact: '', details: '' }
...
const baseValidator: object = { operator_address: '', jailed: false, status: 0, tokens: '', delegator_shares: '', unbonding_height: 0, min_self_delegation: '' }
...
export const Validator = {
  ...
  toJSON(message: Validator): unknown {
    ...
    message.unbonding_time !== undefined && (obj.unbonding_time = message.unbonding_time !== undefined ? message.unbonding_time.toISOString() : null)
...
const baseDVVTriplet: object = { delegator_address: '', validator_src_address: '', validator_dst_address: '' }
...
const baseDelegation: object = { delegator_address: '', validator_address: '', shares: '' }
...
const baseUnbondingDelegation: object = { delegator_address: '', validator_address: '' }
...
const baseUnbondingDelegationEntry: object = { creation_height: 0, initial_balance: '', balance: '' }
...
export const UnbondingDelegationEntry = {
  ...
  toJSON(message: UnbondingDelegationEntry): unknown {
    ...
    message.completion_time !== undefined && (obj.completion_time = message.completion_time !== undefined ? message.completion_time.toISOString() : null)
...
const baseRedelegationEntry: object = { creation_height: 0, initial_balance: '', shares_dst: '' }
...
const baseRedelegation: object = { delegator_address: '', validator_src_address: '', validator_dst_address: '' }
...
const baseParams: object = { max_validators: 0, max_entries: 0, historical_entries: 0, bond_denom: '' }
...
export const Params = {
  ...
  toJSON(message: Params): unknown {
    ...
    message.max_validators !== undefined && (obj.max_validators = message.max_validators)
    message.max_entries !== undefined && (obj.max_entries = message.max_entries)
    message.historical_entries !== undefined && (obj.historical_entries = message.historical_entries)
...
export const RedelegationEntryResponse = {
  ...
  toJSON(message: RedelegationEntryResponse): unknown {
    const obj: any = {}
    message.redelegation_entry !== undefined &&
      (obj.redelegation_entry = message.redelegation_entry ? RedelegationEntry.toJSON(message.redelegation_entry) : undefined)
    message.balance !== undefined && (obj.balance = message.balance)
    return obj
  },

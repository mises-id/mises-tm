...
export const Proposal = {
  ...
  toJSON(message: Proposal): unknown {
    ...
    message.final_tally_result !== undefined &&
      (obj.final_tally_result = message.final_tally_result ? TallyResult.toJSON(message.final_tally_result) : undefined)
    message.submit_time !== undefined && (obj.submit_time = message.submit_time !== undefined ? message.submit_time.toISOString() : null)
    message.deposit_end_time !== undefined && (obj.deposit_end_time = message.deposit_end_time !== undefined ? message.deposit_end_time.toISOString() : null)
    ...
    message.voting_start_time !== undefined &&
      (obj.voting_start_time = message.voting_start_time !== undefined ? message.voting_start_time.toISOString() : null)
    message.voting_end_time !== undefined && (obj.voting_end_time = message.voting_end_time !== undefined ? message.voting_end_time.toISOString() : null)
    return obj
  },
...
const baseTallyResult: object = { yes: '', abstain: '', no: '', no_with_veto: '' }
